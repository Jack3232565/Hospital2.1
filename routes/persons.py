...
@person.get("/persons/", response_model=List[schemas.persons.Person], tags=["Tbb_Personas"],  dependencies=[Depends(Portador())])
...
@person.post("/person/{id}", response_model=schemas.persons.Person, tags=["Tbb_Personas"],  dependencies=[Depends(Portador())])
